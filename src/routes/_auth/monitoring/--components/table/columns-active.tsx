...
export const columnsActive: ColumnDef<PlaygroundSessionView>[] = [
  // ======================
  // NO
  // ======================
  {
  ...
  // ======================
  // MINUTES LEFT (CRITICAL)
  // ======================
  {
    accessorKey: "minutesLeft",
    header: () => <div className="text-right pr-2">Left</div>,
    size: 90,
    maxSize: 90,
    cell: ({ row }) => {
      return <CountdownCell endTime={row.original.endTime} />;
    },
  },
  ...
  // ======================
  {
    ...
    cell: (info) => {
      ...
      return (
        <div className="flex justify-center">
          <ActionCell sessionId={sessionId} />
        </div>
      );
    },
  },
